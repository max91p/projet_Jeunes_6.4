	...
	<main>
        ...
        <table style="width:100%;table-layout: fixed;" cellspacing=4>
            ...
            <tr>
                ...
                <td style="border:2px solid black;margin:0;padding:5px 15px 5px 10px;vertical-align:top;"><div style="height:100%;">
                    Savoir-faire validés :<br><br>
                    <div id="savoir_faire_valides" style="height:150px;overflow-y:scroll">- Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    <br>- Phasellus vel mauris sed nunc varius euismod.
                    <br>- Nam blandit ante in ligula tincidunt, sit amet imperdiet eros aliquam.
                    <br>- Integer pellentesque ante quis accumsan efficitur.
                    <br>- Cras eu mauris ultricies, sollicitudin massa eu, viverra nulla.</div>
                ...
                <td style="border:2px solid black;margin:0;padding:5px 15px 5px 10px;vertical-align:top;"><div style="height:100%;">
                    Savoir-être validés :<br><br>
                    <div id="savoir_etre_valides" style="height:150px;overflow-y:scroll">- Fusce<br>- malesuada<br>- quam<br>- eumi<br>- egestas<br>- faucibus</div>
                </div></td>
            </tr>
        </table>
        <br>
        <p>Envoyé le <span id="date_envoi">01/01/1970</span><br>Statut : <span id="statut">Répondu</span></p>
        <br>
        <br>
        <br>
        <br>
