...
<body style="margin: 0;">
	...
	<main>
		...
		<br>
		<table id="ref2" onclick="clic_ref(this)" style="border:2px solid black; align:center;margin-right:30%;margin-left:30%;width:40%;padding:5px;">
            <tr style="font-size:20px;">
                <td>Milieu : <span class="milieu_experience_liste">Lieu</span><br>Référent(e) : <span class="nom_referent_liste_ref">Prénom NOM</span><br>Date d'envoi : <span class="date_experience_ref_liste">01/01/1970</span></td>
                <td style="vertical-align:top;text-align:right;">Statut : <span class="statut_ref">En attente</span></td>
            </tr>
        </table>         
	</main>
